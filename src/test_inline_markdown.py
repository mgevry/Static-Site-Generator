...
class TestDelimiter(unittest.TestCase):
    ...
    def test_code_bold(self):
        old_node = TextNode("This is text with a **bolded** word", TextType.TEXT)
    ...
    def test_code_italics(self):
        old_node = TextNode("This is text with a _italics_ word", TextType.TEXT)
    ...
    def test_code_double_bold(self):
        old_node = TextNode("This is text with a **bold** word and another **bolder** word", TextType.TEXT)
        new_nodes = split_nodes_delimiter([old_node], "**", TextType.BOLD)
        self.assertListEqual(
            [
                TextNode("This is text with a ", TextType.TEXT),
...
class TestExtract(unittest.TestCase):
    ...
    def test_split_images_with_ending_text(self):
        ...
        self.assertListEqual(
            [
                ...
                TextNode(" with some text after", TextType.TEXT)
            ],
            new_nodes,
        )
    ...
    def test_split_links_with_ending_text(self):
        node = TextNode(
            "This is text with a [link](https://www.google.com) and another [second link](https://www.youtube.com) with some text after",
            TextType.TEXT,
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
    ...
    def test_split_images_no_lead_text(self):
        node = TextNode(
    ...
    def test_split_links_no_lead_text(self):
        node = TextNode(
            "[link](https://www.google.com) and another [second link](https://www.youtube.com)",
            TextType.TEXT,
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
    ...
    def test_split_images_no_between_text(self):
        node = TextNode(
    ...
    def test_split_links_no_between_text(self):
        node = TextNode(
            "This is text with a [link](https://www.google.com)[second link](https://www.youtube.com)",
            TextType.TEXT,
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
